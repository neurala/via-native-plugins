...
public:
	static constexpr const auto values = enumRegisterValues(NEURALA_META_ENUM_ENTRY(B4BError, OK),
	                                                        ...
	                                                        NEURALA_META_ENUM_ENTRY(B4BError, GENERIC_EXCEPTION),
	                                                        NEURALA_META_ENUM_ENTRY(B4BError, GENERIC_ERROR),
	                                                        NEURALA_META_ENUM_ENTRY(B4BError, DEVICE_ERROR),
	                                                        NEURALA_META_ENUM_ENTRY(B4BError, CAMERA_INITIALIZATION_ERROR),
	                                                        NEURALA_META_ENUM_ENTRY(B4BError, CAMERA_SOFTWARE_TRIGGER_ERROR),
	                                                        NEURALA_META_ENUM_ENTRY(B4BError, MODULE_INITIALIZATION_ERROR),
	                                                        NEURALA_META_ENUM_ENTRY(B4BError, UNSUPPORTED_ACTION),
	                                                        NEURALA_META_ENUM_ENTRY(B4BError, TIMEOUT),
	                                                        NEURALA_META_ENUM_ENTRY(B4BError, OVERFLOW_ERROR));
